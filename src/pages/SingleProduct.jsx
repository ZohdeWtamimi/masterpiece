  ...
  return (
    ...
    <div className='container my-4'>
        ...
        <div className="col-6 d-flex flex-column justify-content-around">
            ...
            <p>{product.body}</p>
            <h4> $550 <del className='text-muted'>$700</del></h4>
            <div>
